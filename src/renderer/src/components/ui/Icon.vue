...
/** Lucide-style 24x24 stroke icons, inlined to keep the app fully offline. */
const ICONS: Record<string, string> = {
  ...
  trash:
    '<path d="M3 6h18M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2M19 6l-1 14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2L5 6"/><path d="M10 11v6M14 11v6"/>',
  ...
  'wifi-off':
    '<path d="M2 2l20 20"/><path d="M8.5 16.5a5 5 0 0 1 7 0"/><path d="M2 8.82a15 15 0 0 1 4.17-2.65"/><path d="M10.66 5c4.01-.36 8.14.9 11.34 3.76"/><path d="M16.85 11.25a10 10 0 0 1 2.22 1.68"/><path d="M5 13a10 10 0 0 1 5.24-2.76"/><path d="M12 20h.01"/>',
  receipt:
  ...
  layers:
    '<path d="m12 2 9 4.9L12 12 3 6.9 12 2z"/><path d="m3 12 9 4.9L21 12M3 17l9 4.9L21 17"/>',
  ...
  logo:
    '<rect x="3" y="8" width="18" height="9" rx="2"/><path d="M7 8V4h10v4"/><path d="M7 17v3h10v-3"/><path d="M9 12h6"/>'
}

const content = computed(() => ICONS[props.name] ?? ICONS.box)
</script>
